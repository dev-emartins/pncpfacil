          ...
          <div className="w-full p-5 bg-white rounded-lg shadow-md">   
            <div className="flex md:flex-row flex-col justify-between items-stretch md:gap-8">
              ...
              <div className="w-full md:w-1/2 font-base flex flex-col gap-2.5" > 
                ...
                <p><strong>CNPJ nº: </strong>{ formatCpfCnpj(resultado.orgaoEntidade?.cnpj) || "N/A" }</p>
                <p className="text-justify"><strong>Objeto:</strong> { resultado.objetoCompra || "N/A" }</p>
              </div>

              <div className="w-full md:w-1/2 font-base flex flex-col gap-2.5" >
              <p><strong className="font-bold">Valor Estimado:</strong> { formatCurrency(resultado.valorTotalEstimado) }</p>
