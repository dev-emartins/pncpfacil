        ...
        <div className="w-full p-5 bg-white rounded-lg shadow-md">          
          <div className="flex md:flex-row flex-col justify-between items-stretch gap-5">
            <div className="w-full md:w-1/2">
              <h2 className="text-xl font-bold pb-4">Detalhes do Contrato</h2>
              ...
              <p><strong className="font-bold">Vencido: </strong>{ vencido ? "Vencido" : "Virgente" }</p>
              <p><strong className="font-bold">Data Publicação PNCP:</strong> {formatDate(resultado.dataPublicacaoPncp)}</p>
            </div>
            <div className="w-full md:w-1/2">
              <h2 className="text-xl font-bold pb-4">Arquivo do Contrato</h2>
            </div>
          </div>
          <button
            onClick={() => navigate(-1)}
            className="mt-4 w-32 flex justify-center items-center gap-4 bg-blue-500 text-white font-semibold p-2 rounded-md hover:bg-blue-600 cursor-pointer"
          >
