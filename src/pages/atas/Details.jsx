...
function MinuteDetails() {
  const { cnpj, ano, process, numAta } = useParams()
  ...
  useEffect(() => {
    const fetchDetails = async () => {
      ...
      setErro("")
      try {
        const response = await fetch(`https://pncp.gov.br/pncp-api/v1/orgaos/${cnpj}/compras/${ano}/${process}/atas/${numAta}`)
        console.log(`https://pncp.gov.br/pncp-api/v1/orgaos/${cnpj}/compras/${ano}/${process}/atas/${numAta}`)
        if (!response.ok) {
              ...
              <div className="w-full md:w-1/2 font-base flex flex-col gap-2.5">  
                ...
                <div className="py-5">
                  <a 
                    ...
                    href={`https://pncp.gov.br/pncp-api/v1/orgaos/${cnpj}/compras/${ano}/${process}/atas/${numAta}/arquivos/1`} 
                    target="_blank" 
